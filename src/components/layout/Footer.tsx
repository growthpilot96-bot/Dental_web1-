...
export const Footer: React.FC = () => {
  ...
  const navLinks = [
    { label: 'About Nivora', href: '#about' },
    { label: 'Our Treatments', href: '#treatments' },
    { label: 'Why Choose Us', href: '#why-us' },
    { label: 'Dr. Arjun Devika', href: '#doctor' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 pb-14 border-b border-white/10">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="text-white/70 text-sm leading-relaxed mb-6 max-w-sm">
              {CLINIC_INFO.tagline} Delivering modern clinical excellence and thoughtful patient care in Kunjibettu, Udupi.
            </p>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-3 text-sm text-white/70">
              <p className="flex items-start space-x-2.5">
                ...
                <span>{CLINIC_INFO.address.line1}, {CLINIC_INFO.address.line2}</span>
              </p>
